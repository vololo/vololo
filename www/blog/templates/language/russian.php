...
return array(
	...
	'topic_menu_add_linch' => 'Линч',
	'topic_menu_saved' => 'Черновики',
	'topic_menu_published' => 'Опубликованные',
	/**
	 * Создание топика
	 */
	'topic_linch_create' => 'Создание линча',
	'topic_linch_edit' => 'Редактирование линча',
	...
	'topic_create_linch' => 'URL картинки для линча',
	'topic_create_linch_notice' => 'Картинка должна быть не более 895px по ширине (иначе она будет уменьшена и качество ухудшится). Если вы линчуете несколько страниц или макетов - склеивайте их в одну. По высоте ограничений нет.<br />Вы можете воспользоваться <a href="#" onclick="return false" id="linch_help_link">помощью по линчу</a>.<span id="linch_help">Двойной клик на картинке - добавить блок линча.<br />Тащить за границу блока линча - переместить блок.<br />Двойной клик на границе блока линча - создать указатель.<br />Двойной клик на указателе - удалить указатель.<br />Тащить за кончик указателя - переместить указатель.<br />Тащить за правый-нижний угол блока линча - изменить размер блока.<br />Клик по крестику в блоке линча - удалить блок.<br />Если указатель синий - его можно перемещать, если красный - удалять.<br />Квадратики справа-сверху позволяют выбрать цвет нового блока линча.</span>',
	...
	'topic_create_linch_error' => 'Вы не линчевали картинку',
	...
	'user_stats_sex_other' => 'Гермафродиты',
	...
	'registration_studia' => 'Веб-студия',
	'registration_studia_notice' => 'Если вы не из веб-студии - ничего не пишите',
	...
	'settings_profile_studia' => 'Веб-студия',
	'settings_profile_studia_notice' => 'Если вы не из веб-студии - ничего не пишите',
