{include file='header.light.tpl'}
	...
	<div class="lite-center register">
		<form action="{router page='registration'}" method="POST">
			...
			<label for="studia">{$aLang.registration_studia}:</label><br />
			<p><input type="text" class="input-text" id="studia" name="studia" value="{$_aRequest.studia}"/>
			<span class="input-note">{$aLang.registration_studia_notice}</span></p><br />
