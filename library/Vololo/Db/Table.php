...
class Vololo_Db_Table extends Zend_Db_Table_Abstract
{
	...
	*/
	...
	public function init() {
		parent::init();
		if (isset($this->_multilang_field) || isset($this->_multilang_type)) {
			$this->_current_lang = $reg = Zend_Registry::isRegistered('Vololo_Multilang') ? Zend_Registry::get('Vololo_Multilang') : '';
			if ($reg) {
				$changed = false;
