...
{/literal}
			...
			<form action="" method="POST" enctype="multipart/form-data">
				...
				<p>
					<label for="studia">{$aLang.settings_profile_studia}:</label>
					<input type="text" class="w100p" name="studia" id="studia" value="{$oUserCurrent->getStudia()|escape:'html'}"/><br />
					<span class="form_note">{$aLang.settings_profile_studia_notice}</span>
				</p>
				<p>
