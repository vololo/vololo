...
class ModuleTopic_EntityTopic extends Entity
{
	...
	public function getLinchUrl() {
        return $this->_aData['topic_linchurl'];
    }
	...
	public function getLinchData() {
        return $this->_aData['linch_data'];
    }
    ...
    public function getTagsArray() {
 	...
 	public function getLinchDatas() {
 		return $this->_aData['linch_datas'];
    }
    ...
    public function setBlogId($data) {
 	...
 	public function setLinchData($data) {
        $this->_aData['linch_data']=$data;
    }
	public function setLinchDatas($data) {
        $this->_aData['linch_datas']=$data;
    }
	...
	public function setLinch($data) {
        $this->_aData['topic_linch']=$data;
    }
	public function setLinchUrl($data) {
        $this->_aData['topic_linchurl']=$data;
    }
