<?php /* Smarty version 2.6.19, created on 2010-07-29 21:00:08
         compiled from actions/ActionSettings/profile.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'hook', 'actions/ActionSettings/profile.tpl', 32, false),array('modifier', 'escape', 'actions/ActionSettings/profile.tpl', 37, false),array('modifier', 'date_format', 'actions/ActionSettings/profile.tpl', 61, false),)), $this); ?>
...
"/><br />
				...
				<p>
					<label for="studia"><?php echo $this->_tpl_vars['aLang']['settings_profile_studia']; ?>
:</label>
					<input type="text" class="w100p" name="studia" id="studia" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['oUserCurrent']->getStudia())) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
"/><br />
					<span class="form_note"><?php echo $this->_tpl_vars['aLang']['settings_profile_studia_notice']; ?>
</span>
				</p>
				<p>
					<label for=""><?php echo $this->_tpl_vars['aLang']['settings_profile_sex']; ?>
:</label><br />
					<label for="profile_sex_m"><input type="radio" name="profile_sex" id="profile_sex_m" value="man" <?php if ($this->_tpl_vars['oUserCurrent']->getProfileSex() == 'man'): ?>checked<?php endif; ?> class="radio" />  &mdash;  <?php echo $this->_tpl_vars['aLang']['settings_profile_sex_man']; ?>
</label><br />
					<label for="profile_sex_w"><input type="radio" name="profile_sex" id="profile_sex_w" value="woman" <?php if ($this->_tpl_vars['oUserCurrent']->getProfileSex() == 'woman'): ?>checked<?php endif; ?> class="radio" />  &mdash;  <?php echo $this->_tpl_vars['aLang']['settings_profile_sex_woman']; ?>
</label><br />
					<label for="profile_sex_o"><input type="radio" name="profile_sex" id="profile_sex_o"  value="other" <?php if ($this->_tpl_vars['oUserCurrent']->getProfileSex() == 'other'): ?>checked<?php endif; ?> class="radio" />  &mdash;  <?php echo $this->_tpl_vars['aLang']['settings_profile_sex_other']; ?>
</label>
				</p>
				<p>
