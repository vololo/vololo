<?php /* Smarty version 2.6.19, created on 2010-07-29 20:21:04
...
:</label><br />
			...
			<label for="studia"><?php echo $this->_tpl_vars['aLang']['registration_studia']; ?>
:</label><br />
			<p><input type="text" class="input-text" id="studia" name="studia" value="<?php echo $this->_tpl_vars['_aRequest']['studia']; ?>
"/>
			<span class="input-note"><?php echo $this->_tpl_vars['aLang']['registration_studia_notice']; ?>
</span></p><br />
