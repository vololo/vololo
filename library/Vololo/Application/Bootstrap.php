...
class Vololo_Application_Bootstrap extends Zend_Application_Bootstrap_Bootstrap {
    /**
     * Инициализация приложения
     */

	protected function _initApp() {
		Zend_Controller_Action_HelperBroker::addPrefix('Vololo_Controller_Action_Helper');
	}
	...
	protected function _initConfig() {
		$path = APPLICATION_PATH.'/../library/Vololo/Application/configs';
	...
	protected function _initDebug() {
		if ($this->hasOption('zfdebug')) {
			...
			if ($opt['active']) {
				$this->bootstrap('db');
	            Zend_Controller_Front::getInstance()->registerPlugin(new Vololo_Controller_Plugin_Debug($opt));
			}
       	}
	}
